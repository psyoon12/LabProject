...
public class Movement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.Translate(Vector3.right * horizontalMovement * speed * Time.fixedDeltaTime);
        transform.Translate(Vector3.left * horizontalMovement * speed * Time.fixedDeltaTime);
        transform.Translate(Vector3.up * verticalMovement * speed * Time.fixedDeltaTime);
